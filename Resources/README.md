...
There is a single `md` file for each of the collected resources. Indexing is done from the [issues section](https://github.com/e-CLOSE/Toolbox/issues?q=label%3A02_RESOURCE), and you can also access related tools by following the labels next to the titles in each tool description file.
